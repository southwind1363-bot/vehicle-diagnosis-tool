...
final class ELMReadCommandTests: XCTestCase {
    ...
    func testInitialQueueIsExactlyTheFixedReadOnlySet() {
        XCTAssertEqual(
            ELMReadCommand.allCases.map(\.wireValue).filter { !["0108", "0109", "016A", "016C", "018E"].contains($0) },
        ...
        XCTAssertTrue(["016A", "016C", "018E"].allSatisfy(ELMReadCommand.allCases.map(\.wireValue).contains))
