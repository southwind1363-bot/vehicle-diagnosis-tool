...
final class ELMReadCommandTests: XCTestCase {
    ...
    func testInitialReadoutPlanIsAnExplicitReadOnlyAllowlist() {
        XCTAssertEqual(
            ...
            [
                ...
                .identifyAdapter, .storedDTC, .describeProtocol, .describeProtocolNumber,
                .pendingDTC, .permanentDTC,
    ...
    func testEveryVehicleReadoutUsesAnAllowedReadIntent() {
        ...
        XCTAssertEqual(ELMReadCommand.readinessStatus.intent, "read_readiness")
