(function () {
  ...
  function getDiagnosticSessionInput(input = {}) {
    ...
    return {
      ...
      vehicle_profile: base.vehicle_profile || base.vehicleProfile || nested.vehicle_profile || nested.vehicleProfile || null,
      vehicle_applicability: base.vehicle_applicability || base.vehicleApplicability || nested.vehicle_applicability || nested.vehicleApplicability || null,
      connectionStatus: pickPresent(input.connectionStatus, input.connection_status, payload?.connectionStatus, payload?.connection_status, nested.connectionStatus, nested.connection_status, null),
      connection_status: pickPresent(input.connection_status, input.connectionStatus, payload?.connection_status, payload?.connectionStatus, nested.connection_status, nested.connectionStatus, null),
      vciDevices: pickPresent(input.vciDevices, input.vci_devices, input.vciList, input.vci_list, payload?.vciDevices, payload?.vci_devices, payload?.vciList, payload?.vci_list, nested.vciDevices, nested.vci_devices, nested.vciList, nested.vci_list, null),
      vci_devices: pickPresent(input.vci_devices, input.vciDevices, input.vci_list, input.vciList, payload?.vci_devices, payload?.vciDevices, payload?.vci_list, payload?.vciList, nested.vci_devices, nested.vciDevices, nested.vci_list, nested.vciList, null),
      adapterIdentity: pickPresent(input.adapterIdentity, input.adapter_identity, payload?.adapterIdentity, payload?.adapter_identity, nested.adapterIdentity, nested.adapter_identity, null),
      adapter_identity: pickPresent(input.adapter_identity, input.adapterIdentity, payload?.adapter_identity, payload?.adapterIdentity, nested.adapter_identity, nested.adapterIdentity, null),
