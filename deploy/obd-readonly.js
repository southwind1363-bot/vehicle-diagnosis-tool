(function () {
  ...
  function getDiagnosticSessionInput(input = {}) {
    ...
    return {
      ...
      coreSessionStatus: pickPresent(input.coreSessionStatus, input.core_session_status, payload?.coreSessionStatus, payload?.core_session_status, nested.coreSessionStatus, nested.core_session_status, null),
      core_session_status: pickPresent(input.core_session_status, input.coreSessionStatus, payload?.core_session_status, payload?.coreSessionStatus, nested.core_session_status, nested.coreSessionStatus, null),
      diagnosticFlowSummary: pickPresent(input.diagnosticFlowSummary, input.diagnostic_flow_summary, payload?.diagnosticFlowSummary, payload?.diagnostic_flow_summary, nested.diagnosticFlowSummary, nested.diagnostic_flow_summary, null),
      diagnostic_flow_summary: pickPresent(input.diagnostic_flow_summary, input.diagnosticFlowSummary, payload?.diagnostic_flow_summary, payload?.diagnosticFlowSummary, nested.diagnostic_flow_summary, nested.diagnosticFlowSummary, null),
      readoutCompletionSummary: pickPresent(input.readoutCompletionSummary, input.readout_completion_summary, payload?.readoutCompletionSummary, payload?.readout_completion_summary, nested.readoutCompletionSummary, nested.readout_completion_summary, null),
      readout_completion_summary: pickPresent(input.readout_completion_summary, input.readoutCompletionSummary, payload?.readout_completion_summary, payload?.readoutCompletionSummary, nested.readout_completion_summary, nested.readoutCompletionSummary, null),
      analysisReadinessSummary: pickPresent(input.analysisReadinessSummary, input.analysis_readiness_summary, payload?.analysisReadinessSummary, payload?.analysis_readiness_summary, nested.analysisReadinessSummary, nested.analysis_readiness_summary, null),
      analysis_readiness_summary: pickPresent(input.analysis_readiness_summary, input.analysisReadinessSummary, payload?.analysis_readiness_summary, payload?.analysisReadinessSummary, nested.analysis_readiness_summary, nested.analysisReadinessSummary, null),
      readoutQualitySummary: pickPresent(input.readoutQualitySummary, input.readout_quality_summary, payload?.readoutQualitySummary, payload?.readout_quality_summary, nested.readoutQualitySummary, nested.readout_quality_summary, null),
