...
const OBD_CORE_PROGRESS_SNAPSHOT = Object.freeze({
  validationCheckLabel: "OBD安全検証 7215件",
  bridgeValidationCheckLabel: "bridge検証 318件",
  recentMilestone: "サービス安全条件を診断セッション保存へ統合",
  scopeNote: "自動検証件数は実車確認済み車種数や完成率ではありません"
});
const APP_VERSION = "3.13.321";
...
function analyzeObdScannerImport(options = {}) {
  ...
  if (bridgeImport && obdDevSession.lastSession) {
    ...
    renderObdBridgeSessionDetails(obdDevSession.lastSession);
  }
  renderObdSessionExportControls();
}
