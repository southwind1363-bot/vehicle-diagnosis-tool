...
2026-06-13時点で、現行・履歴を合わせた車名候補341件、型式・エンジン型式まで持つ詳細候補313車種、年式範囲769件、DTC records 1122件を登録しています。未登録の組み合わせは推測で補わず、手入力とメーカー資料確認へ戻します。
汎用DTCは確認済み範囲をP0A5Fまで段階的に拡張し、P084F、P085A～P085F、P086A～P086F、P087A～P087F、P088C～P088F、P089A～P089F、P090A～P090F、P095A～P095F、P099A～P099F、P0A60以降の未確認範囲は名称を確定できる公式資料の確認待ちです。発電機電流センサー回路と駆動モーターA U相電流を収録し、高電圧部品周辺は有資格者による指定遮断・待機・無電圧確認を必須としています。
