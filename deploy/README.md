...
2026-06-13時点で、現行・履歴を合わせた車名候補341件、型式・エンジン型式まで持つ詳細候補313車種、年式範囲769件、DTC records 976件を登録しています。未登録の組み合わせは推測で補わず、手入力とメーカー資料確認へ戻します。
汎用DTCは確認済み範囲をP0949まで段階的に拡張し、P084F、P085A～P085F、P086A～P086F、P087A～P087F、P088C～P088F、P089A～P089F、P090A～P090F、P0950以降の未確認範囲は名称を確定できる公式資料の確認待ちです。油圧ポンプリレー回路と自動変速手動モード適応学習未完了の診断手順を収録しています。
