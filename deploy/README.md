...
2026-06-12時点で、現行・履歴を合わせた車名候補341件、型式・エンジン型式まで持つ詳細候補313車種、年式範囲769件、DTC records 884件を登録しています。未登録の組み合わせは推測で補わず、手入力とメーカー資料確認へ戻します。
汎用DTCは確認済み範囲をP0859まで段階的に拡張し、P084Fは名称を確定できる公式資料の確認待ちです。パーク・ニュートラル入力、ドライブスイッチ入力、トラクション制御入力を含む診断手順を収録しています。
