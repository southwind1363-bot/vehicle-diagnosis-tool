...
2026-06-14時点で、現行・履歴を合わせた車名候補341件、型式・エンジン型式まで持つ詳細候補313車種、年式範囲769件、DTC records 1179件を登録しています。未登録の組み合わせは推測で補わず、手入力とメーカー資料確認へ戻します。
汎用DTCはP0A9Aまで名称を確認し、P084F、P085A～P085F、P086A～P086F、P087A～P087F、P088C～P088F、P089A～P089F、P090A～P090F、P095A～P095F、P099A～P099F、P0A9B以降の未確認範囲は公式資料の確認待ちです。モーター・発電機性能、DC/DC性能、高電圧ヒューズ、HVバッテリー冷却ファン2を収録し、既存P0A93を公式のインバーターA冷却システム性能定義へ更新しました。
