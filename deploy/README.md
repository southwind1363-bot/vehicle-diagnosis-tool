...
2026-06-13時点で、現行・履歴を合わせた車名候補341件、型式・エンジン型式まで持つ詳細候補313車種、年式範囲769件、DTC records 916件を登録しています。未登録の組み合わせは推測で補わず、手入力とメーカー資料確認へ戻します。
汎用DTCは確認済み範囲をP088Bまで段階的に拡張し、P084F、P085A～P085F、P086A～P086F、P087A～P087Fは名称を確定できる公式資料の確認待ちです。TCM電源リレー制御・監視とフルードフィルター劣化の診断手順を収録しています。
