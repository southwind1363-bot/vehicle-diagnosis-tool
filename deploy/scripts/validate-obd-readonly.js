...
check(blockedPreparedClear.ok === false && blockedPreparedClear.blocked === true && blockedPreparedClear.wouldTransmit === false, "DTC消去要求が送信不可で拒否されていません");
...
if (failures.length) {
  ...
  console.log("OBD read-only safety checks: 37");
