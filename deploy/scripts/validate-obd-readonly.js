...
const coreSessionStatusFunctionChecks = () => {
  ...
  if (coreSessionStatusFunctionSource) {
    ...
    check(source.includes('const changedIdDirectionPriority = { mixed: 0, added: 1, removed: 2 };') && source.includes('primaryChangedIdDirectionSummary: primaryChangedIdDirection ? changedIdDirectionSummary[primaryChangedIdDirection] || null : null,'), "imported session comparison summaries should expose primary changed id direction");
