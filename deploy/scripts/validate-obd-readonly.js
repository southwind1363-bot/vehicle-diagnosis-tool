...
const coreSessionStatusFunctionChecks = () => {
  ...
  if (coreSessionStatusFunctionSource) {
    ...
    check(source.includes('const primaryChangedIdDirection = ["mixed", "added", "removed"]') && source.includes('primaryChangedIdDirectionSummary: primaryChangedIdDirection ? changedIdDirectionSummary[primaryChangedIdDirection] || null : null,'), "imported session comparison summaries should expose primary changed id direction");
...
check(["added", "removed", "mixed"].includes(mergedDiagnosticInputExportPayload.importedSessionComparisonSummary?.primaryChangedIdDirection), "Combined diagnostic inputs did not expose imported session primary changed id direction");
...
check(scanSessionBridgeDiagnosticImportAlias.importedSessionComparisonSummary?.primaryChangedIdDirectionSummary && Number.isFinite(scanSessionBridgeDiagnosticImportAlias.importedSessionComparisonSummary.primaryChangedIdDirectionSummary.count), "Diagnostic scan session did not expose imported session primary changed id direction");
