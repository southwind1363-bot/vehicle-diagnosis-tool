...
vm.runInContext(["renderObdBridgeMeasurementValues", "formatObdFreezeFrameValueLine", "getObdDisplayByteNumber", "formatObdFreezeFrameTriggerEntry", "formatObdBridgeReadoutValue", "formatObdBridgeCompositeValue", "buildObdFreezeFrameDispositionLines", "formatReadoutErrorCodes", "formatObdReadoutStatus"].map(extract).join("\n"), context);
