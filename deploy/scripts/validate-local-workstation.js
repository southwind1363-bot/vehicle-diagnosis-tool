...
function validateReadoutNavigation() {
  ...
  const context = vm.createContext({ document: { getElementById: (id) => nodes[id] }, window: { scrollY: 320, scrollTo: (options) => scrollCalls.push(options) },
    ...
    clearObdOperationJournalViewer: () => {}, renderObdOperationJournalViewer: () => {},
...
async function validatePortableNpmScripts() {
  ...
  assert.deepEqual(manifest.scripts, {
    ...
    "validate:readiness-review": "node scripts/validate-readiness-review.js",
    "validate:readiness-review-browser": "node scripts/validate-readiness-review-browser.cjs",
    "validate:scanner-browser": "node scripts/validate-scanner-file-flow.cjs --offline --dense-live && node scripts/validate-case-import-browser.cjs --bulk --unsafe-id --delete-identity --csv",
    ...
    "validate:operation-journal-viewer": "node scripts/validate-operation-journal-viewer.cjs",
    "validate:operation-journal-save": "node scripts/validate-operation-journal-save.cjs",
    ...
    "validate:dtc-scope": "node scripts/validate-dtc-clear-fixture-scope.js",
    "validate:dtc-scoped-readout": "node scripts/validate-dtc-clear-scoped-before-readout.js",
    "validate:dtc-scoped-post-readout": "node scripts/validate-dtc-clear-scoped-post-readout.js",
    "validate:dtc-sequence": "node scripts/validate-dtc-clear-readout-sequence.js",
    "validate:dtc-before-evidence": "node scripts/validate-dtc-clear-before-evidence.js",
    "validate:dtc-difference-boundaries": "node scripts/validate-dtc-clear-difference-boundaries.js",
    "validate:dtc-post-evidence": "node scripts/validate-dtc-clear-post-evidence.js",
...
function createClient(webUrl, token, fetchRequest = fetch) {
  const context = vm.createContext({
    ...
    // Journal rendering and target binding have dedicated validation suites.
    clearObdOperationJournalViewer: () => {}, clearObdOperationJournalComparison: () => {}, renderObdOperationJournalViewer: () => {},
